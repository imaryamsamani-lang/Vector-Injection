...
class GemmaConfig:
    ...
    '/home/maryam/Downloads/New_Paper/gemma_pytorch/tokenizer/tokenizer.model' #'tokenizer/tokenizer.model'
    )
...
def get_config_for_4b(dtype: str) -> GemmaConfig:
  return GemmaConfig(
      ...
      vocab_size=262_144,
      tokenizer='/home/maryam/Downloads/New_Paper/gemma_pytorch/tokenizer/gemma3_cleaned_262144_v2.spiece.model',
      use_qk_norm=True,
